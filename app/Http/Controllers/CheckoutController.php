...
class CheckoutController extends Controller
{
    public function shipping(Request $request)
    {
        ...
        if (session('customer_id')) {
            ...
            return view('auth.pages.checkout.shipping', compact('content'), [
    ...
    {
        $content = Cart::content();
        return view('auth.pages.checkout.payment', compact('content'));
    }
    ...
    public function complete()
    {
        ...
        $content = Cart::content();
        return view('auth.pages.checkout.complete', compact('content', 'shipping', 'payment_method', 'order_id'));
    }
    ...
    public function viewOrders(Request $request)
    {
        ...
        if (session('customer_id')) {
            ...
            return view('auth.pages.checkout.order', compact('orders'));
        }
        return redirect()->route('home');
    }
}
