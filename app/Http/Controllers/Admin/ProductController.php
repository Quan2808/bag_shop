...
class ProductController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('auth.pages.product.index', compact('categories', 'products'));
    }
    ...
    {
        $categories = Category::all();
        $product = Product::all()->where('products_model', $id)->firstOrFail();
        ...
        $related_products = Product::where('categories_id', $product->categories_id)
            ...
            ->take(4)
            ->get();
        $product_manage = view('auth.pages.product.show', compact('product', 'category', 'categories', 'related_products', 'url'));
        return view('auth.layouts.app', ['content' => $product_manage]);
    }
    ...
    public function search(Request $request)
    {
        ...
        $products = Product::where('products_model', 'LIKE', $searchTerm . '%')
            ...
            ->paginate(12);
        return view('auth.pages.product.search', compact('categories', 'products', 'searchTerm'));
    }
}
