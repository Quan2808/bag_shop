                                        ...
                                        @foreach ($content as $contents)
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-5 col-md-6 mb-4 mb-lg-0">
                                                    ...
                                                    <div class="d-flex">
                                                        <form action="{{ route('product.show', $contents->name) }}"
                                                        ...
                                                        <form action="{{ route('cart.remove', $contents->rowId) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('POST')
                                                ...
                                                <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                                                    ...
                                                    <div class="d-flex mb-4" style="max-width: 300px">
                                                        <form action="{{ route('cart.update', $contents->rowId) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('PUT')
                            ...
                            <div class="card-body">
                                <ul class="list-group list-group-flush">
                                    <li
                                        ...
                                        Products
                                        <span>{{ number_format(Cart::subtotal(), 0, '.', ',') }} VND</span>
                                    </li>

                                    <li
                                        class="list-group-item d-flex justify-content-between align-items-center border-0 px-0 pb-0">
                                        Tax
                                        <span>{{ number_format(Cart::tax(), 0, '.', ',') }} VND</span>
                                    </li>
                                ...
                                <a href="{{ route('checkout.shipping') }}" type="button"
