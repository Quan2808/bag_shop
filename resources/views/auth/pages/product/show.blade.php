...
@section('content')
    <main class="mt-5">
        ...
        <section class="section-parallax section-parallax-breadcrumb bg-top">
            <div class="container">
                <h1 class="text-white">{{ $product->products_model }}</h1>
                                    ...
                                    <div class="col-lg-6 px-5 py-4">
                                        ...
                                        <form action="{{ route('cart.add', $product->products_id) }}" method="post">
                                            ...
                                            <div class="card-header">
                                                <h3 class="pt-2 text-center fw-bold text-uppercase">
                                                    {{ $product->products_model }}
                                                </h3>
                                            </div>
                                                            ...
                                                            <div class="d-flex align-items-start">
                                                                <div class="flex-grow-1 ms-4">
                                                                    <p class="mb-1">
                                                                        ...
                                                                        <a href="{{route('agentSystem')}}">Agent system</a>.
                                                                    </p>
        ...
        <section class="h-100 h-custom" style="background-color: #eee;">
            <div class="container h-100 py-5">
                <div class="row d-flex justify-content-center align-items-center h-100">
                    <h2 class="text-center fw-bold">Related products</h2>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-evenly align-items-center pb-2 mb-1">
                                            <a href="{{ route('product.show', ['id' => $product->products_id]) }}"
